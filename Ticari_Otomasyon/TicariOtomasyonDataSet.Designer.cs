...
SELECT ID, AD, YETKİLİ, YETKİLİADSOYAD, TELEFON1, TELEFON2, TELEFON3, MAİL, FAKS, İL, İLCE, VERGİDAİRE, ADRES, YETKILITC, OZELKOD1, OZELKOD2, OZELKOD3, SEKTOR FROM TBL_FİRMALAR WHERE (ID = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(TicariOtomasyonDataSet.TBL_FİRMALARDataTable dataTable) {
        ...
        public virtual TicariOtomasyonDataSet.TBL_FİRMALARDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TicariOtomasyonDataSet.TBL_FİRMALARDataTable dataTable = new TicariOtomasyonDataSet.TBL_FİRMALARDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TicariOtomasyonDataSet.TBL_FİRMALARDataTable dataTable) {
